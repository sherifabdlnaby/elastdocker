...
<p align="center">
   <a>
      <img src="https://img.shields.io/badge/Elastic%20Stack-7.6.1-blue?style=flat&logo=elasticsearch" alt="Elastic Stack Version 7^^">
   </a>
   <a>
...
Stack Version: [7.6.1](https://www.elastic.co/blog/elastic-stack-7-6-0-released).
...
* Some Configuration are parameterized in the `.env` file.
  ...
  * `ELK_VERSION` Elastic Stack Version (default: `7.6.1`)
