...
<p align="center">
   <a>
      <img src="https://img.shields.io/badge/Elastic%20Stack-7.9.0-blue?style=flat&logo=elasticsearch" alt="Elastic Stack Version 7^^">
   </a>
   <a>
...
* Some Configuration are parameterized in the `.env` file.
  ...
  * `ELK_VERSION` Elastic Stack Version (default: `7.9.0`)
